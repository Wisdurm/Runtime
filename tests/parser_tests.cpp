...
TEST_CASE("Top level statements", "[parser]")
{
	...
	const char* test1 = "i\nAssign(i-0,1)";
	ast::Expression* r1 = new ast::Call(L, "Object", { new ast::Identifier(L,"Main"), new ast::Identifier(L, "i"), new ast::Call(L, "Assign", { new ast::BinaryOperator(L,new ast::Identifier(L, "i"), new ast::Literal(L, 0)), new ast::Literal(L, 1) })});
